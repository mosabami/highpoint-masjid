        ...
        <div className="max-w-7xl mx-auto">
          <div className="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
            ...
            <div className="relative pt-6 px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
                  <div className="flex items-center justify-between w-full md:w-auto">
                    <a href="/">
                        ...
                        <span className="sr-only">{this.state.data.name}</span>
                        <img
                          className={`${this.state.data.branding.larger_logo ? "h-32" : "h-16"} w-auto`}
                          src={this.state.data.branding.logo_url}
                          alt="hero"
                        />
              ...
              <HeroText data={this.state.data} />
          </div>
        </div>
        <HeroBanne data={this.state.data} />
      </div>
    )
  }
}

              ...
              <li key={person.name}>
                <div className="space-y-4 sm:grid sm:grid-cols-3 sm:gap-6 sm:space-y-0 lg:gap-8">
                  <div className="h-0 aspect-w-3 aspect-h-2 sm:aspect-w-3 sm:aspect-h-4">
                    <img className="object-contain md:object-cover shadow-lg rounded-lg hover:opacity-40 transition duration-300 ease-in-out bg-white" src={person.image_url} alt="" />
                  </div>
